...
#command.
#PSH Begin
INCLUDES = -I/oscar/rt/9.6/25/spack/x86_64_v3/hdf5-1.14.6-wybiluvczs2xlln2joat23umn3cp7oil/mod/shared
#PSH End
...
ifndef MPI_FLAGS
#PSH Begin
# change to make use of hpcx-mpi (openmpi)
#FPPFLAGS += $(shell pkg-config --cflags-only-I)
#PSH End
else
FPPFLAGS += $(MPI_FLAGS)
endif
...
#FFLAGS := -fcray-pointer -fdefault-real-8 -fdefault-double-8 -Waliasing -ffixed-line-length-200 -fno-range-check -fallow-invalid-boz -fallow-argument-mismatch
#FFLAGS := -fcray-pointer -fdefault-real-8 -fdefault-double-8 -Waliasing -ffixed-line-length-200 -fno-range-check -fallow-invalid-boz -fallow-argument-mismatch -Wline-truncation
FFLAGS := -fcray-pointer -fdefault-real-8 -fdefault-double-8 -Waliasing -ffree-line-length-none -fno-range-check -fallow-invalid-boz -fallow-argument-mismatch -Wline-truncation
...
ifndef MPI_FLAGS
#PSH Begin
# change to use hpcx-mpi (openmpi) instead of mpich2)
...
ifndef MPI_LIBS
#PSH Begin
# modifying to use with hpcx-mpi (openmpi)
